...
<body>
    ...
    <div class="top-buttons">
        <!-- Updated link to redirect to my.html -->
        <a href="my.html">My Profile</a>
        <a href="course.html" id="course-reflection">Course Reflection</a>
        <a href="team.html">Team</a> <!-- Link directly to team.html -->
        <a href="businesscase.html" id="business-cases">Business Cases</a> <!-- Redirect to businesscase.html -->
        <!-- New button to redirect to city.html -->
        <a href="city.html">City Design</a> <!-- Redirect to city.html -->
    </div>
